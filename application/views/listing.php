...
<!-- Mirrored from askbootstrap.com/preview/osahan-eat/listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Dec 2021 06:31:50 GMT -->
<head>
...
<a href="#">
<img class="img-fluid" src="<?php echo base_url();?>assets/img/list/1.png" alt="">
<h6>American</h6>
<p>156</p>
</a>
</div>
...
<div class="osahan-category-item">
<a href="#">
<img class="img-fluid" src="<?php echo base_url();?>assets/img/list/2.png" alt="">
<h6>Pizza</h6>
<p>120</p>
</a>
</div>
...
<div class="osahan-category-item">
<a href="#">
<img class="img-fluid" src="<?php echo base_url();?>assets/img/list/3.png" alt="">
<h6>Healthy</h6>
<p>130</p>
</a>
</div>
...
<div class="osahan-category-item">
<a href="#">
<img class="img-fluid" src="<?php echo base_url();?>assets/img/list/4.png" alt="">
<h6>Vegetarian</h6>
<p>120</p>
</a>
</div>
...
<div class="osahan-category-item">
<a href="#">
<img class="img-fluid" src="<?php echo base_url();?>assets/img/list/5.png" alt="">
<h6>Chinese</h6>
<p>111</p>
</a>
</div>
...
<div class="osahan-category-item">
<a href="#">
<img class="img-fluid" src="<?php echo base_url();?>assets/img/list/6.png" alt="">
<h6>Hamburgers</h6>
<p>958</p>
</a>
</div>
...
<div class="osahan-category-item">
<a href="#">
<img class="img-fluid" src="<?php echo base_url();?>assets/img/list/7.png" alt="">
<h6>Dessert</h6>
<p>56</p>
</a>
</div>
...
<div class="osahan-category-item">
<a href="#">
<img class="img-fluid" src="<?php echo base_url();?>assets/img/list/8.png" alt="">
<h6>Chicken</h6>
<p>40</p>
</a>
</div>
...
<div class="osahan-category-item">
<a href="#">
<img class="img-fluid" src="<?php echo base_url();?>assets/img/list/9.png" alt="">
<h6>Indian</h6>
<p>156</p>
</a>
</div>
...
<script src="<?php echo base_url();?>assets/vendor/jquery/jquery-3.3.1.slim.min.js" type="92b62fb37c76315b731548f2-text/javascript"></script>

<script src="<?php echo base_url();?>assets/vendor/bootstrap/js/bootstrap.bundle.min.js" type="92b62fb37c76315b731548f2-text/javascript"></script>

<script src="<?php echo base_url();?>assets/vendor/select2/js/select2.min.js" type="92b62fb37c76315b731548f2-text/javascript"></script>

<script src="<?php echo base_url();?>assets/vendor/owl-carousel/owl.carousel.js" type="92b62fb37c76315b731548f2-text/javascript"></script>

<script src="<?php echo base_url();?>assets/js/custom.js" type="92b62fb37c76315b731548f2-text/javascript"></script>
<scrip src="<?php echo base_url();?>assets/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="92b62fb37c76315b731548f2-|49" defer=""></script><scrip defer src="<?php echo base_url();?>assets/https://static.cloudflareinsights.com/beacon.min.js/v64f9daad31f64f81be21cbef6184a5e31634941392597" integrity="sha512-gV/bogrUTVP2N3IzTDKzgP0Js1gg4fbwtYB6ftgLbKQu/V8yH2+lrKCfKHelh4SO3DPzKj4/glTO+tNJGDnb0A==" data-cf-beacon='{"rayId":"6b9378b30eac6efa","version":"2021.11.0","r":1,"token":"dd471ab1978346bbb991feaa79e6ce5c","si":100}' crossorigin="anonymous"></script>
...
<script type="text/javascript" language="javascript">
  $(document).ready(function(){
    function fetch_data(){
      $.ajax({
        url:"<?php echo base_url();?>main_page/lists",
        method:"POST",
