...
<!-- Mirrored from askbootstrap.com/preview/osahan-eat/orders.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Dec 2021 06:31:58 GMT -->
<head>
...
<input type="password" value="**********" class="form-control" placeholder="Enter passwords">
</div>
</div>
</form>
</div>
...
<img class="mb-3 rounded-pill shadow-sm mt-1" src="<?php echo base_url();?>assets/img/user/4.png" alt="gurdeep singh osahan">
<div class="osahan-user-media-body">
<h6 class="mb-2">Gurdeep Singh</h6>
<p class="mb-1">+91 85680-79956</p>
<p><a href="https://askbootstrap.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="761f171b1905171e171836111b171f1a5815191b">[email&#160;protected]</a></p>
...
<a href="#">
<div class="media">
<img class="mr-4" src="<?php echo base_url();?>assets/img/3.jpg" alt="Generic placeholder image">
<div class="media-body">
<span class="float-right text-info">Delivered on Mon, Nov 12, 7:18 PM <i class="icofont-check-circled text-success"></i></span>
<h6 class="mb-2">
<a href="<?php echo base_url();?><?php echo base_url('detail');?>" class="text-black">Gus's World Famous Fried Chicken
</a></h6>
...
<a class="btn btn-sm btn-primary" href="<?php echo base_url();?><?php echo base_url('detail');?>"><i class="icofont-refresh"></i> REORDER</a>
</div>
...
<a href="#">
<div class="media">
<img class="mr-4" src="<?php echo base_url();?>assets/img/4.jpg" alt="Generic placeholder image">
<div class="media-body">
<span class="float-right text-info">Delivered on Mon, Nov 12, 7:18 PM <i class="icofont-check-circled text-success"></i></span>
<h6 class="mb-2">
<a href="<?php echo base_url();?><?php echo base_url('detail');?>" class="text-black">Jimmy's Famous American Tavern
</a></h6>
...
<a href="#">
<div class="media">
<img class="mr-4" src="<?php echo base_url();?>assets/img/5.jpg" alt="Generic placeholder image">
<div class="media-body">
<span class="float-right text-info">Delivered on Mon, Nov 12, 7:18 PM <i class="icofont-check-circled text-success"></i></span>
<h6 class="mb-2">
<a href="<?php echo base_url();?><?php echo base_url('detail');?>" class="text-black">The Famous Restaurant
</a></h6>
...
<div class="card-body">
<h5 class="card-title"><img src="<?php echo base_url();?>assets/img/bank/1.png"> OSAHANEAT50</h5>
...
<div class="card offer-card shadow-sm">
<div class="card-body">
<h5 class="card-title"><img src="<?php echo base_url();?>assets/img/bank/2.png"> EAT730</h5>
<h6 class="card-subtitle mb-2 text-block">Get 50% OFF on your first osahan eat order</h6>
...
<div class="card offer-card shadow-sm">
<div class="card-body">
<h5 class="card-title"><img src="<?php echo base_url();?>assets/img/bank/3.png"> SAHAN50</h5>
<h6 class="card-subtitle mb-2 text-block">Get 50% OFF on your first osahan eat order</h6>
...
<div class="card offer-card shadow-sm">
<div class="card-body">
<h5 class="card-title"><img src="<?php echo base_url();?>assets/img/bank/4.png"> GURDEEP50</h5>
<h6 class="card-subtitle mb-2 text-block">Get 50% OFF on your first osahan eat order</h6>
...
<div class="favourite-heart text-danger position-absolute"><a href="<?php echo base_url();?><?php echo base_url('detail');?>"><i class="icofont-heart"></i></a></div>
<div class="member-plan position-absolute"><span class="badge badge-dark">Promoted</span></div>
<a href="<?php echo base_url();?><?php echo base_url('detail');?>">
<img src="<?php echo base_url();?>assets/img/list/4.png" class="img-fluid item-img">
</a>
</div>
<div class="p-3 position-relative">
<div class="list-card-body">
<h6 class="mb-1"><a href="<?php echo base_url();?><?php echo base_url('detail');?>" class="text-black">Famous Dave's Bar-B-Que
</a>
</h6>
...
<div class="member-plan position-absolute"><span class="badge badge-dark">Promoted</span></div>
<a href="<?php echo base_url();?><?php echo base_url('detail');?>">
<img src="<?php echo base_url();?>assets/img/list/5.png" class="img-fluid item-img">
</a>
</div>
<div class="p-3 position-relative">
<div class="list-card-body">
<h6 class="mb-1"><a href="<?php echo base_url();?><?php echo base_url('detail');?>" class="text-black">Thai Famous Cuisine</a></h6>
...
<div class="member-plan position-absolute"><span class="badge badge-dark">Promoted</span></div>
<a href="<?php echo base_url();?><?php echo base_url('detail');?>">
<img src="<?php echo base_url();?>assets/img/list/6.png" class="img-fluid item-img">
</a>
</div>
<div class="p-3 position-relative">
<div class="list-card-body">
<h6 class="mb-1"><a href="<?php echo base_url();?><?php echo base_url('detail');?>" class="text-black">The osahan Restaurant
</a>
</h6>
...
<div class="p-3 position-relative">
<div class="list-card-body">
<h6 class="mb-1"><a href="<?php echo base_url();?><?php echo base_url('detail');?>" class="text-black">Stan's Restaurant
</a>
</h6>
 <p class="text-gray mb-3">North Indian • Indian • Pure veg</p>
...
<div class="p-3 position-relative">
<div class="list-card-body">
<h6 class="mb-1"><a href="<?php echo base_url();?><?php echo base_url('detail');?>" class="text-black">Polo Lounge
</a>
</h6>
<p class="text-gray mb-3">North Indian • Indian • Pure veg</p>
<p class="text-gray mb-3 time"><span class="bg-light text-dark rounded-sm pl-2 pb-1 pt-1 pr-2"><i class="icofont-wall-clock"></i> 15–25 min</span> <span class="float-right text-black-50"> $250 FOR TWO</span></p>
...
<div class="p-3 position-relative">
<div class="list-card-body">
<h6 class="mb-1"><a href="<?php echo base_url();?><?php echo base_url('detail');?>" class="text-black">Jack Fry's
</a>
 </h6>
<p class="text-gray mb-3">North Indian • Indian • Pure veg</p>
<p class="text-gray mb-3 time"><span class="bg-light text-dark rounded-sm pl-2 pb-1 pt-1 pr-2"><i class="icofont-wall-clock"></i> 15–25 min</span> <span class="float-right text-black-50"> $250 FOR TWO</span></p>
...
<a href="#">
<div class="media">
<img class="mr-3" src="<?php echo base_url();?>assets/img/bank/1.png" alt="Generic placeholder image">
<div class="media-body">
...
<a href="#">
<div class="media">
<img class="mr-3" src="<?php echo base_url();?>assets/img/bank/2.png" alt="Generic placeholder image">
<div class="media-body">
<h6 class="mb-1">6070-XXXXXXXX-0666</h6>
<p>VALID TILL 10/2025</p>
<p class="mb-0 text-black font-weight-bold">
...
<a href="#">
<div class="media">
<img class="mr-3" src="<?php echo base_url();?>assets/img/bank/3.png" alt="Generic placeholder image">
<div class="media-body">
<h6 class="mb-1">6070-XXXXXXXX-0666</h6>
<p>VALID TILL 10/2025</p>
<p class="mb-0 text-black font-weight-bold">
...
<a href="#">
<div class="media">
<img class="mr-3" src="<?php echo base_url();?>assets/img/bank/4.png" alt="Generic placeholder image">
<div class="media-body">
<h6 class="mb-1">6070-XXXXXXXX-0666</h6>
<p>VALID TILL 10/2025</p>
<p class="mb-0 text-black font-weight-bold">
...
<a href="#">
<div class="media">
<img class="mr-3" src="<?php echo base_url();?>assets/img/bank/5.png" alt="Generic placeholder image">
<div class="media-body">
<h6 class="mb-1">6070-XXXXXXXX-0666</h6>
<p>VALID TILL 10/2025</p>
<p class="mb-0 text-black font-weight-bold">
...
<a href="#">
<div class="media">
<img class="mr-3" src="<?php echo base_url();?>assets/img/bank/6.png" alt="Generic placeholder image">
<div class="media-body">
 <h6 class="mb-1">6070-XXXXXXXX-0666</h6>
<p>VALID TILL 10/2025</p>
<p class="mb-0 text-black font-weight-bold">
...
<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="<?php echo base_url();?>assets/vendor/jquery/jquery-3.3.1.slim.min.js" type="aa3c7e056d5ab874380fc1a6-text/javascript"></script>

<script src="<?php echo base_url();?>assets/vendor/bootstrap/js/bootstrap.bundle.min.js" type="aa3c7e056d5ab874380fc1a6-text/javascript"></script>

<script src="<?php echo base_url();?>assets/vendor/select2/js/select2.min.js" type="aa3c7e056d5ab874380fc1a6-text/javascript"></script>

<script src="<?php echo base_url();?>assets/js/custom.js" type="aa3c7e056d5ab874380fc1a6-text/javascript"></script>
